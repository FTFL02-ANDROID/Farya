...
import com.ftfl.icaremyself.util.JSONParser;
...
public class CareCenterGoogleMapActivity extends FragmentActivity implements LocationListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent i = getIntent();
		mAddress = i.getStringExtra(mAddress);
		mLatitude = i.getStringExtra(mLatitude);
		mLongitude = i.getStringExtra(mLongitude);
	...
	public void onStatusChanged(String provider, int status, Bundle extras) {
	 ...
	 private class connectAsyncTask extends AsyncTask<Void, Void, String>{
		    ...
		    protected void onPreExecute() {
		        // TODO Auto-generated method stub
		        super.onPreExecute();
		        progressDialog = new ProgressDialog(CareCenterGoogleMapActivity.this);
