...
public class CreateProfileActivity extends Activity implements OnClickListener, OnDateSetListener{
    ...
    MyProfileDBSource mDBSource = null;
	...
	public void onClick(View v) {
		...
		case R.id.btnSave:
			...
			if (   ( !mName.equals("")) && ( !mDateOfBirth.equals("")) &&
				...
				toast = Toast.makeText(CreateProfileActivity.this, "Enter all data.", Toast.LENGTH_LONG);
				toast.show();
			}
