...
public class ATMDBHelper extends SQLiteOpenHelper{
    ...
    // ATM Profile Table
	public static final String ATM_PROFILE_TABLE = "atmprofiles";
	public static final String COL_ATM_PROFILE_ID = "id";
	//public static final String COL_ATM_PROFILE_IMAGE = "image";
	...
	private static final String DATABASE_CREATE_PROFILE = "create table "
			+ ATM_PROFILE_TABLE + "( " + COL_ATM_PROFILE_ID
	...
	public void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion) {
		...
		database.execSQL("DROP TABLE IF EXISTS " + ATM_PROFILE_TABLE);		
		onCreate(database);
